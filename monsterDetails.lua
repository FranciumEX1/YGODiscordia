...
function monsterStats.getAttack(cardName)
    ...
    local searcher = conn:exec("SELECT Attack FROM Monsters WHERE Cardname = '" .. cardName .. "'")
...
function monsterStats.getDefense(cardName)
    local conn = dbase.open("YuGiscord.db")
    local searcher = conn:exec("SELECT Defense FROM Monsters WHERE Cardname = '" .. cardName .. "'")
    local result = tonumber(searcher[1][1])
    conn:close()
    return result
end
...
function monsterStats.getLevel(cardName)
    local conn = dbase.open("YuGiscord.db")
    local searcher = conn:exec("SELECT Level FROM Monsters WHERE Cardname = '" .. cardName .. "'")
    local result = tonumber(searcher[1][1])
    conn:close()
    return result
end
...
function monsterStats.getAttribute(cardName)
    local conn = dbase.open("YuGiscord.db")
    local searcher = conn:exec("SELECT Attribute FROM Monsters WHERE Cardname = '" .. cardName .. "'")
...
function monsterStats.getSubType(cardName)
    local conn = dbase.open("YuGiscord.db")
    local searcher = conn:exec("SELECT SubType FROM Monsters WHERE Cardname = '" .. cardName .. "'")
    local result = searcher[1][1]
    conn:close()
    return result
end
...
function monsterStats.cardTitle(cardName)
    local conn = dbase.open("YuGiscord.db")
    local searcher = conn:exec("SELECT Cardname FROM Monsters WHERE Cardname = '" .. cardName .. "'")
    local result = searcher[1][1]
    conn:close()
    return result
end
...
function monsterStats.cardImage(cardName)
    local conn = dbase.open("YuGiscord.db")
    local searcher = conn:exec("SELECT Card FROM Monsters WHERE Cardname = '" .. cardName .. "'")
    local result = searcher[1][1]
    conn:close()
    return result
end
...
function monsterStats.getDescription(cardName)
    local conn = dbase.open("YuGiscord.db")
    local searcher = conn:exec("SELECT Description FROM Monsters WHERE Cardname = '" .. cardName .. "'")
    local result = searcher[1][1]
    conn:close()
    return result
end
